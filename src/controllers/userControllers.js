  ...
  exports.resetPassword = async (req,res) => {
    try {
      ...
      return res.status(200).json({success: true, message : "Password Reset Succesfull"});
    } catch(error) {
      console.error(error);
      return res.status(500).json({success: false, message:"Error in Resetting the Password", error: error});
    }
  };
